...
import { ArrowLeft, Loader2, X, Cloud, Plus, Trash2 } from "lucide-react";
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3 pt-4 border-t">
                ...
                <p className="text-sm text-muted-foreground">
                  Upload invoices, scopes, diagrams, quotes, or spreadsheets for this service request.
                </p>
                ...
                {/* OneDrive URL Input */}
                <div className="space-y-2">
                  <Label htmlFor="invoice-onedrive">Optional OneDrive link</Label>
